    ...
    return (
        <div className="flex min-h-[calc(100vh-5rem)] flex-col items-center justify-between bg-gray-100 p-4 text-black">
            <div className="w-full px-6 py-4 text-gray-400">
                <Breadcrumbs segments={["datenschutzerklarung"]} />
            </div>
            <div className="max-w-[800px]">
                ...
                <div className="flex flex-col justify-center space-y-2 py-4">
                    ...
                    <p>
                        ...
                        handeln. Das externe Hosting erfolgt zum Zwecke der
                        ...
                        in Bezug auf diese Daten befolgen. Wir setzen
                        folgende(n) Hoster ein: Vercel
                    </p>
                </div>
                ...
                <div className="flex flex-col justify-center space-y-2 py-4">
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p>
                            ...
                            den gesetzlichen Datenschutzvorschriften sowie
                            dieser Datenschutzerklärung. Wenn Sie diese Website
                            ...
                            geschieht. Wir weisen darauf hin, dass die
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p>
                            ...
                            speziellere Speicherdauer genannt wurde, verbleiben
                            Ihre personenbezogenen Daten bei uns, bis der Zweck
                            für die Datenverarbeitung entfällt. Wenn Sie ein
                            ...
                            rechtlich zulässigen Gründe für die Speicherung
                            Ihrer personenbezogenen Daten haben (z. B. steuer-
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p>
                            ...
                            werden. Im Falle einer ausdrücklichen Einwilligung
                            in die Übertragung personenbezogener Daten in
                            Drittstaaten erfolgt die Datenverarbeitung außerdem
                            auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO.
                            Sofern Sie in die Speicherung von Cookies oder in
                            den Zugriff auf Informationen in Ihr Endgerät (z. B.
                            via Device-Fingerprinting) eingewilligt haben,
                            erfolgt die Datenverarbeitung zusätzlich auf
                            Grundlage von § 25 Abs. 1 TDDDG. Die Einwilligung
                            ist jederzeit widerrufbar. Sind Ihre Daten zur
                            Vertragserfüllung oder zur Durchführung
                            vorvertraglicher Maßnahmen erforderlich, verarbeiten
                            wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit.
                            b DSGVO. Des Weiteren verarbeiten wir Ihre Daten,
                            sofern diese zur Erfüllung einer rechtlichen
                            Verpflichtung erforderlich sind auf Grundlage von
                            Art. 6 Abs. 1 lit. c DSGVO. Die Datenverarbeitung
                            kann ferner auf Grundlage unseres berechtigten
                            Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen.
                            Über die jeweils im Einzelfall einschlägigen
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p>
                            ...
                            mit verschiedenen externen Stellen zusammen. Dabei
                            ist teilweise auch eine Übermittlung von
                            personenbezogenen Daten an diese externen Stellen
                            erforderlich. Wir geben personenbezogene Daten nur
                            dann an externe Stellen weiter, wenn dies im Rahmen
                            einer Vertragserfüllung erforderlich ist, wenn wir
                            gesetzlich hierzu verpflichtet sind (z. B.
                            Weitergabe von Daten an Steuerbehörden), wenn wir
                            ein berechtigtes Interesse nach Art. 6 Abs. 1 lit. f
                            DSGVO an der Weitergabe haben oder wenn eine
                            ...
                            Grundlage eines gültigen Vertrags über
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p>
                            ...
                            NACH ART. 21 ABS. 1 DSGVO). WERDEN IHRE
                            ...
                            IHRE PERSONENBEZOGENEN DATEN ANSCHLIESSEND NICHT
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <p>
                            ...
                            Berichtigung oder Löschung dieser Daten. Hierzu
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <ul className="list-disc px-4">
                                <li>
                                    ...
                                    bestreiten, benötigen wir in der Regel Zeit,
                                    um dies zu überprüfen. Für die Dauer der
                ...
                <div className="flex flex-col justify-center space-y-2 py-4">
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <p>
                                ...
                                Dienstleistungen von Drittunternehmen innerhalb
                            ...
                            <p>
                                ...
                                bestimmte Webseitenfunktionen ohne diese nicht
                                funktionieren würden (z. B. die
                                Warenkorbfunktion oder die Anzeige von Videos).
                                Andere Cookies können zur Auswertung des
                                Nutzerverhaltens oder zu Werbezwecken verwendet
                                werden.
                            </p>
                            <p>
                                Cookies, die zur Durchführung des elektronischen
                                Kommunikationsvorgangs, zur Bereitstellung
                                bestimmter, von Ihnen erwünschter Funktionen (z.
                                B. für die Warenkorbfunktion) oder zur
                                Optimierung der Website (z. B. Cookies zur
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex flex-col space-y-1">
                            <p>
                                Diese Website nutzt das Tool{" "}
                                <strong>yesCookie</strong>, um die Zustimmung
                                zur Speicherung bestimmter Cookies auf Ihrem
                                Endgerät einzuholen und diese datenschutzkonform
                                zu dokumentieren. yesCookie ermöglicht es den
                                Nutzern, über die Nutzung von Cookies auf
                                unserer Website informiert zu werden und
                                individuelle Einstellungen vorzunehmen, welche
                                Cookies sie zulassen oder ablehnen möchten.
                            </p>
                            <p>
                                Die Verwendung von yesCookie erfolgt, um den
                                gesetzlichen Verpflichtungen nach der DSGVO
                                (Art. 6 Abs. 1 lit. c DSGVO) nachzukommen. Die
                                Verarbeitung der Daten erfolgt auf Grundlage
                                Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
                                Diese Einwilligung können Sie jederzeit
                                widerrufen.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex flex-col space-y-1">
                            <p>
                                ...
                                Server-LogDateien, die Ihr Browser automatisch
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex flex-col space-y-1">
                            <p>
                                ...
                                Anfrageformular inklusive der von Ihnen dort
                                angegebenen Kontaktdaten zwecks Bearbeitung der
                                Anfrage und für den Fall von Anschlussfragen bei
                                uns gespeichert. Diese Daten geben wir nicht
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex flex-col space-y-1">
                            <p>
                                ...
                                Dienst können Website-Tags über eine Oberfläche
                                verwaltet werden. Der Google Tag Manager
                                implementiert lediglich Tags. Das bedeutet, dass
                                keine Cookies verwendet und keine
                                personenbezogenen Daten erfasst werden. Der
                                Google Tag Manager löst andere Tags aus, die
                                wiederum unter Umständen Daten erfassen. Der
                                Google Tag Manager greift jedoch nicht auf diese
                                Daten zu. Wenn auf Domain- oder Cookie-Ebene
                                eine Deaktivierung vorgenommen wurde, bleibt
                                diese für alle Tracking-Tags bestehen, die mit
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex flex-col space-y-1">
                            <p>
                                ...
                                Webanalysedienstes Google Analytics 4 (GA4).
                            </p>
                            <p>
                                Google Analytics 4 sammelt verschiedene
                                Datenpunkte, darunter Informationen über das
                                Nutzerverhalten auf der Website, die
                                Interaktionen und die Quelle des Zugriffs. Im
                                Gegensatz zur vorherigen Version von Google
                                Analytics verwendet GA4 eine ereignisbasierte
                                Datenstruktur, bei der die Erhebung von
                                Nutzerdaten flexibler gestaltet ist und weniger
                                stark von Cookies abhängt.
                            </p>
                            <p>
                                GA4 ermöglicht eine Analyse des Nutzerverhaltens
                                auf Basis von Ereignissen und aggregierten
                                Daten. Die gesammelten Informationen werden in
                                der Regel an Server von Google übertragen und
                                dort verarbeitet. Dabei werden auch
                                standardmäßig Anonymisierungsfunktionen wie die
                                IP-Anonymisierung genutzt, um die Privatsphäre
                                der Nutzer zu schützen.
                            </p>
                            <p>
                                Die Nutzung von Google Analytics 4 erfolgt auf
                                Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
                                Websitebetreiber hat ein berechtigtes Interesse
                                an der Analyse des Nutzerverhaltens, um sein
                                Webangebot und seine Werbung zu optimieren.
                                Sofern eine entsprechende Einwilligung abgefragt
                                wurde (z. B. zur Speicherung von Cookies),
                ...
                <div className="flex flex-col justify-center space-y-2 py-4">
                    ...
                    <p>
                        ...
                        Inc. findet dabei nicht statt. Weitere Informationen zu
                        Font Awesome finden Sie in der Datenschutzerklärung für
