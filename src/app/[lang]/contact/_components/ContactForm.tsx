        ...
        <form onSubmit={handleSubmit(onSubmitHandler)}>
            {isSubmitSuccessful ? (
                ...
                <>
                    ...
                    <button
                        className="mt-4 w-full rounded-xl bg-gradient-to-r from-[#5651e5] to-[#709dff] p-4 text-gray-100 shadow-xl shadow-gray-400 transition-transform duration-300 ease-in-out hover:from-[#709dff] hover:to-[#5651e5] hover:shadow-2xl"
                        type="submit"
                    >
                        {submitButton}
                    </button>
