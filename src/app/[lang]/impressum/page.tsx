        ...
        <div className="flex min-h-[calc(100vh-5rem)] flex-col items-center justify-between bg-gray-100 p-4 text-black">
            ...
            <div className="max-w-[800px]">
                ...
                <div className="flex flex-col space-y-2 py-4">
                    ...
                    <p>
                        Für die Informationen, die auf dieser Website
                        bereitgestellt werden, sowie für etwaige Probleme,
                        Verluste oder Schäden, die durch die Nutzung dieser
                        Website entstehen, übernehme ich keine Verantwortung.
                        <br />
                        Die Struktur, die Nutzungsbedingungen, die URL und die
                        Inhalte dieser Website können ohne vorherige Ankündigung
                        geändert oder gelöscht werden. <br />
                        Bitte haben Sie dafür Verständnis. Es kann auch
                        vorkommen, dass der Betrieb dieser Website ohne
                        Ankündigung unterbrochen oder eingestellt wird. <br />
                        Wir bitten um Ihr Verständnis. Die Nutzungsbedingungen
                        können ebenfalls ohne vorherige Ankündigung geändert
                        werden. Bitte beachten Sie dies im Voraus.
                    </p>
                </div>
                ...
                <div className="flex flex-col space-y-2 py-4">
                    ...
                    <p>
                        ...
                        Werke, insbesondere die im Rahmen unserer
                        Dienstleistungen erstellten Materialien, unterliegen dem
                        deutschen Urheberrecht. Jede vom deutschen Urheberrecht
            ...
            unangemessen erachtet.`}
                ...
                <div className="flex flex-col space-y-2 py-4">
                    ...
                    <p>
                        Bezüglich der Links von dieser Website zu anderen
                        Websites gilt: Die verlinkten Websites werden unter der
                        Verantwortung der jeweiligen Betreiber verwaltet, und{" "}
                        {companyName} übernimmt keine Gewähr für deren Inhalte.
                        Ebenso übernimmt {companyName} keine Haftung für
                        eventuelle Probleme oder Schäden, die durch die Nutzung
                        dieser Websites entstehen können. Ein Link bedeutet
                        nicht, dass {companyName} die verlinkten Websites und
                        deren Inhalte empfiehlt, noch besteht eine besondere
                        Beziehung zwischen
                        {companyName} und den Betreibern der verlinkten
                        Websites.
                    </p>
                </div>
                ...
                <div className="flex flex-col space-y-2 py-4">
                    ...
                    <p>
                        {companyName} respektiert die persönlichen Daten, die
                        Sie uns zur Verfügung gestellt haben, und bemüht sich um
                        den Schutz Ihrer Privatsphäre. Bitte beachten Sie unsere
