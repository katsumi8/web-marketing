export default function Impressum() {
  const name = process.env.NEXT_PUBLIC_NACHNAME; // あなたのフルネーム
    ...
    <div className="flex h-full flex-col items-center justify-between bg-gray-100 p-4 text-black">
      <div className="max-w-[800px]">
        ...
        <p className="mb-2">
          ...
          dem deutschen Urheberrecht. Jede vom deutschen Urheberrecht nicht
          zugelassene Verwertung bedarf der vorherigen schriftlichen Zustimmung
          des Anbieters oder jeweiligen Rechteinhabers.
        </p>
